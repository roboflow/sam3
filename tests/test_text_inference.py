...
# checkpoint_path = thisdir / "../sam3_checkpoint.pt" # need to download the weights file
checkpoint_path = thisdir / "testdata/last_run/sam3_logs/checkpoints/checkpoint.pt" # finetune generated by test_instance_segmentation_finetune.py
